        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                   ...
                   <ul class="sub">
						<li><a href="generateSpotReport.jsp">Generated Spot Report</a></li>
                   </ul>
                </li>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form action="ViewSpecificStationDetails.jsp">
                                <div class="form-group">
                                    <label for="Station ID">Station ID</label>
                                    <input type="number" name="id" class="form-control" id="id" placeholder="Enter Station ID" required="required">
                                </div>
