...
<title>Delete Specific Account</title>
</head>
...
body{
       ...
       background: radial-gradient(#0095B6,#FFFFFF);
...
try
{
	...
	PreparedStatement stmt4 = conn.prepareStatement("delete from addstation where id=?");
	stmt4.setInt(1,id);
