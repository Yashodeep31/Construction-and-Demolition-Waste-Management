     ...
     <div style ="overflow-x:auto;">   
                            <center><table>
                              ...
                              <%
                                ...
                                try
                                {
								PreparedStatement ps1 = con.prepareStatement("select * from addspot where level=?");
                              ...
                              %>	
                                ...
                                <td><a href="DeleteStationZone.jsp?id=<%=rs1.getInt("id")%>">Delete</a> </td> 
