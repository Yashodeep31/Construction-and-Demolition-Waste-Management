...
<!DOCTYPE html>
<head>
<title>View Specific spot</title>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    ...
                    <ul class="sub">
						<li><a href="AddBlackSpotView.html">Add Black Spot </a></li>
                ...
                <li>
                   ...
                   <ul class="sub">
						...
						<li><a href="TypeWise.jsp">Type Wise Spots Report</a></li>
                   </ul>
                </li>
				...
				<div class="col-md-12 w3ls-graph">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            VIEW TYPE WISE BLACK SPOT
                        </header>
                        <div class="panel-body">
                            <div class="position-center">
                                <form action="TypeWiseDetails.jsp">
                           <center> 
                             <div class="form-group">
                               ...
                               <center> <button type="submit" class="btn btn-info">View Station</button></center>
                            </form>
                             <center> <img  src="images\" width="500px" height="300px"></center>
                            </div>
