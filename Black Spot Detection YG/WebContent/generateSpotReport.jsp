...
<html>
<head>
<title>Spot Report For Admin</title>
    ...
    <div class="table-responsive">
      <div style ="overflow-x:auto;">   
        ...
        <%
                                ...
                                try
                                {
								PreparedStatement ps1 = con.prepareStatement("select * from addspot");
        ...
        %>	
          ...
          <tr>
                               <tr>
                                ...
                                <td><a href="DeleteSpotFromAdmin.jsp?id=<%=rs1.getInt("id")%>">Delete</a> </td>  
