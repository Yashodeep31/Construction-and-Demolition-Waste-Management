    ...
    <div class="table-responsive">
      <div style ="overflow-x:auto;">   
        ...
        <%
                                ...
                                try
                                {
								PreparedStatement ps1 = con.prepareStatement("select * from addstation where id=?");
								ps1.setInt(1,id);
        ...
        %>	
          ...
          <tr>
                                ...
                                <td><%=rs1.getString("saddress")%></td>
                                <td><%=rs1.getString("scontact") %> </td>
                                <td><%=rs1.getString("email")%> </td>  
                                <td><%=rs1.getString("password")%> </td>  
                                <td><a href="DeleteSpecificStation.jsp?id=<%=rs1.getInt("id")%>">Delete</a> </td> 
