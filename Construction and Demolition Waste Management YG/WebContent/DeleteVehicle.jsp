                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Driver Contact</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><%=rs.getInt("srno") %></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><%=rs.getInt("vnum") %></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><%=rs.getString("dname") %></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><%=rs.getString("dcontact") %></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><%=rs.getString("latitude") %></span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><%=rs.getString("longitude") %></span>
                      </td  class="align-middle text-center text-sm">
                      <script>
                      function showAlert1() {
                      alert ("Deletion process happen successfully..!");
                      }
                     </script>
                      <th class="badge badge-sm bg-gradient-success"><a href="delete.jsp?srno=<%=rs.getInt("srno")%>"><button type="button" class="delete" onclick="showAlert1()">Delete</button></a></th>
                    </tr>
                    <%
                      i++;
                      }
