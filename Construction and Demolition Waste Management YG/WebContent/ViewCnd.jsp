...
<%@page import="yashodeep.Credential" %>
<%
...
<li class="nav-item">
  <a class="nav-link " href="RaiseCnd.html">
    
      <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
      </div>
    
    <span class="nav-link-text ms-1">Raise CND Request</span>
  </a>
</li>

  
<li class="nav-item">
  <a class="nav-link " href="ViewCnd.jsp">
    
      <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
      </div>
    
    <span class="nav-link-text ms-1">View CND Request</span>
  </a>
</li>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <%
try{
String a=Credential.getEmail();
con=DriverManager.getConnection(connectionUrl+database,userid,password);
String sql="select * from cnd where email=?";
