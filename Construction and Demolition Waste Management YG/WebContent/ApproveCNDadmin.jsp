...
String sql ="select * from cnd where status='Approve'";
...
%>
                    <tr>
                      ...
                      <td class="align-middle text-center" >
                        <script>
                     function showAlert1() {
                      alert ("Mark as completed happen successfully..!");
                      }
                     </script> 
                      <th class="badge badge-sm bg-gradient-success"><a href="WorkAs.jsp?id=<%=rs.getString("id") %>"><button type="button" class="MarkAs" onclick="showAlert1()">Completed</button></a></th>
                       </td>
                    </tr>
                    <%
                      i++;
